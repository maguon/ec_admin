...
const AccountModal = (props)=>{
    ...
    const{appReducer,setAccountModalOpenFlag} = props;
    ...
    return(
        <SimpleModal
            title="修改密码"
            open={appReducer.accountModalOpenFlag}
            showFooter={true}
            footer={
                <>
                    ...
                    <Button onClick={()=>{setAccountModalOpenFlag(false)}} color="primary" autoFocus>
                        取消
                    </Button>
                </>
            }
            onClose={()=>{setAccountModalOpenFlag(false)}}> 
